...
namespace Kniffel
{
    internal class Program
    {
        ...
        static void ExplainTheRules()//generated by ChatGPT
        {
            Console.Clear();
            Console.WriteLine("THE RULES\n");
            Console.WriteLine("Throwing Mechanism:");
            Console.WriteLine("• Each turn, you have up to three rolls.");
            Console.WriteLine("• On the first roll, you throw all five dice.");
            Console.WriteLine("• After the first roll, choose which dice to keep and which to re-roll.");
            Console.WriteLine("• You can re-roll the remaining dice up to two more times to try to form a scoring combination.");
            Console.WriteLine();
            Console.WriteLine("Scoring Combinations:");
            Console.WriteLine("1. Ones - Count of ones (1 point per one)");
            Console.WriteLine("2. Twos - Count of twos (2 points per two)");
            Console.WriteLine("3. Threes - Count of threes (3 points per three)");
            Console.WriteLine("4. Fours - Count of fours (4 points per four)");
            Console.WriteLine("5. Fives - Count of fives (5 points per five)");
            Console.WriteLine("6. Sixes - Count of sixes (6 points per six)");
            Console.WriteLine("   *Bonus: 50 points if sum of 1-6 >= 63*");
            Console.WriteLine();
            Console.WriteLine("7. Three of a Kind - Three same dice (e.g. 3-3-3-2-5 = 16 points)");
            Console.WriteLine("10. Four of a Kind - Four same dice (e.g. 2-2-2-2-6 = 14 points)");
            Console.WriteLine("15. Yatzy - Five of a kind (50 points)");
            Console.WriteLine("14. Chance - Sum of all dice (any combination)");
            Console.WriteLine("13. Full House - Three of a kind + a pair (25 points)");
            Console.WriteLine("11. Small Straight - 1-2-3-4 / 2-3-4-5 / 3-4-5-6 (30 points)");
            Console.WriteLine("12. Large Straight - 1-2-3-4-5 / 2-3-4-5-6 (40 points)");
        ...
        static void Ending()
        {
            ...
            int numbersPoints = 0;
            int bonusPoints;
            int otherCombinations;
            numbersPoints += ones.points + twos.points + threes.points + fours.points + fives.points + sixs.points;            
            otherCombinations = triplet.points+ quadruplet.points + kniffel.points + chance.points + fullHouse.points + smallStraight.points + largeStraight.points;
            if (numbersPoints > 62) bonusPoints = 50;
            else bonusPoints = 0;

            finalScore = numbersPoints + otherCombinations + bonusPoints;

            Console.Clear();
            Console.WriteLine("Well played!!");
            Console.WriteLine("\nNumbers combinations: " + numbersPoints + " points");
            Console.WriteLine("--> Bonus: " + bonusPoints + " points");
            Console.WriteLine("Other combinations: " + otherCombinations + " points");
            Console.WriteLine("-------------------------------");
